...
2. **Git**:
   - To install Git (no admin rights needed), run this in Command Prompt (cmd):
     ```cmd
...
1. Clone the repository:
   ```bash
   git clone https://github.com/omegadevelopmentsfr/Qemu-gui-launcher.git
   cd Qemu-gui-launcher
   ```
...
3. Extract the contents into a folder named `qemu` **inside** this project's directory.
   - You should end up with: `.../portable-qemu-launcher/qemu/qemu-system-x86_64w.exe`
